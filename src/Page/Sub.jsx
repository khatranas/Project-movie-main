    ...
    <hr class="w-full h-px mt-5 bg-gray-200 border-0 dark:bg-gray-700"></hr>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 text-center mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <button
            type="button"
            class="text-black bg-alert hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900"
          >
            Access Premium
          </button>
          ...
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div className="flex flex-col p-6 mx-6 max-w-screen-2xl text-center text-gray-900 bg-white rounded-3xl border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <button
                type="button"
                class="py-2.5 mb-2 rounded-3xl text-sm font-medium text-Label focus:outline-none bg-white border border-Label hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="flex flex-col p-6 mx-6 max-w-screen-2xl text-center text-white bg-Label rounded-3xl border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <button
                type="button"
                class="py-2.5 mb-2 rounded-3xl text-sm font-medium text-white focus:outline-none bg-Label border border-white hover:bg-purple-300 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
              >
                Get Started
              </button>
            </div>
